...
if (isset($_POST["register"])) {
 ...
 if (mysqli_num_rows($result) > 0) {
   ...
   $insert_query = "INSERT INTO `register` (`Fname`, `Lname`, `email`, `Password`) VALUES ('$Fname', '$Lname', '$email','$pass')";
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block"><img src="img/gettyimages.jpg" alt="" width="800px" height ="600px"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repeat Password" required name="cpass">
                                    </div>
                                    
                                </div>
                                <button  type="submit" name="register"  class="btn btn-primary btn-user btn-block" a href="login.php">Register </button>
                                </a><hr>
